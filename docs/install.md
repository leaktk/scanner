...
```
# Replace TAG with a specific tag from https://quay.io/repository/leaktk/scanner?tab=tags
...
```sh
# Replace vX.Y.Z with the specific tag from https://github.com/leaktk/scanner/releases
